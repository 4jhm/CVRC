    ...
    public class VROverlayService : IDisposable
    {
        ...
        public bool Connect()
        {
            ...
            try
            {
                ...
                var oErr = OpenVR.Overlay.CreateOverlay("vrcnext.wristoverlay", "CVRC Wrist", ref _overlayHandle);
                ...
                var tErr = OpenVR.Overlay.CreateOverlay("vrcnext.toast", "CVRC Toast", ref _toastHandle);
        ...
        private void PointerMove(float nx, float ny)
        {
            if (!_mouseDown) return;

            if (_activeTab == TabExpressions && _exprDragName != null)
            {
                int gdixM = (int)(nx * W);
                int gdiyM = (int)((1f - ny) * H);
        ...
        private void CreatePointerOverlays()
        {
            ...
            var lErr = OpenVR.Overlay.CreateOverlay("vrcnext.laser", "CVRC Laser", ref _laserHandle);
            ...
            var dErr = OpenVR.Overlay.CreateOverlay("vrcnext.laserdot", "CVRC Pointer", ref _dotHandle);
